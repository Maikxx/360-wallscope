        ...
        switch (true) {
            case el[0].x == el[1].x:
                (()=>{
                    ...
                    newCircleStart.setAttribute("cx",el[0].y > el[1].y ? linkSpacing(el[0].el,"check")[0] * 20 + el[0].x : linkSpacing(el[0].el,"check")[2] * 20 + el[0].x)
                    newCircleStart.setAttribute("cy",el[0].y > el[1].y ? el[0].y - el[0].height/2 : el[0].y + el[0].height/2)
                    newCircleEnd.setAttribute("cx",el[0].y < el[1].y ? linkSpacing(el[1].el,"check")[1] * 20 + el[1].x : linkSpacing(el[1].el,"check")[2] * 20 + el[1].x)
                    newCircleEnd.setAttribute("cy",el[0].y < el[1].y ? el[1].y - el[1].height/2 : el[1].y + el[1].height/2)
                    
                    newLine.setAttribute("x1",el[0].y > el[1].y ? linkSpacing(el[0].el,"check")[0] * 20 + el[0].x : linkSpacing(el[0].el,"check")[2] * 20 + el[0].x)
                    newLine.setAttribute("x2",el[0].y > el[1].y ? linkSpacing(el[0].el,"check")[0] * 20 + el[0].x : linkSpacing(el[0].el,"check")[2] * 20 + el[0].x)

                    newLine.setAttribute("y1",el[0].y + (el[0].height/2))
                    newLine.setAttribute("y2",el[1].y - (el[1].height/2))
            ...
            case el[0].y == el[1].y:
                (()=>{
                    ...
                    newCircleStart.setAttribute("r",5)
                    newCircleEnd.setAttribute("r",5)
                    newCircleStart.setAttribute("cx",`${el[0].x > el[1].x ? el[0].x - el[0].width/2 : el[0].x + el[0].width/2}`)
                    newCircleStart.setAttribute("cy",el[0].y)
                    newCircleEnd.setAttribute("cx",`${el[0].x < el[1].x ? el[1].x - el[1].width/2 : el[1].x + el[1].width/2}`)
                    ...
                    newLine.setAttribute("x1",el[0].x + (el[0].width/2))
                    newLine.setAttribute("x2",el[1].x - (el[1].width/2))
