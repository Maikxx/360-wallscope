...
export class Icon extends React.Component<Props> {
    public render() {
        ...
        if (iconName) {
            ...
            return (
                <i className={this.getClassName()} dangerouslySetInnerHTML={{ __html: icon(color) }}/>
            )
        } else {
            return null
        }
