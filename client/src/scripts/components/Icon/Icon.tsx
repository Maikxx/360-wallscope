...
interface Props {
    className?: string
    iconName?: 'user' | 'search_big' | 'search_small' | 'pen' | 'settings' | 'light_dark' | 'boards'
    color?: string
}
