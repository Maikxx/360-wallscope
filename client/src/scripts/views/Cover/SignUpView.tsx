        ...
        return (
            <CoverView>
                ...
                <Form onSubmit={this.onFormSubmit}>
                    ...
                    <Button aria_label='sign up' styleOverride='ultraviolet-button' type='submit' full={true}>
                        Sign up
                    </Button>
                    <Button aria_label='log in' styleOverride='orange-button' full={true} type='button' onClick={() => this.props.history.push(routes.Login.index)}>
